...
class SuperAdminPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(SuperAdminPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class AdminPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(AdminPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class CDDSpecialistPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(CDDSpecialistPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class EvaluatorPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(EvaluatorPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class AccountantPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(AccountantPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class RegionalCoordinatorPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(RegionalCoordinatorPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class NationalCoordinatorPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(NationalCoordinatorPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class GeneralManagerPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(GeneralManagerPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class DirectorPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(DirectorPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class AdvisorPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(AdvisorPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class MinisterPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(MinisterPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class InfraPermissionRequiredMixin(UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(InfraPermissionRequiredMixin, self).dispatch(
            request, *args, **kwargs
        )
