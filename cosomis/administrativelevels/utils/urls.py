...
urlpatterns = [
    path(
        "get-administrative-level-for-cvd-by-adl",
        views.GetAdministrativeLevelForCVDByADLView.as_view(),
        name="get_administrative_level_for_cvd_by_adl",
    ),
    path(
        "get-choices-for-next-administrative-level-no-condition",
        views.GetChoicesForNextAdministrativeLevelNoConditionView.as_view(),
    ...
    path(
        "get-choices-for-next-administrative-level-by-geographical-unit",
    ...
    path(
        "get-choices-for-next-administrative-level-all",
        views.GetChoicesForNextAdministrativeLevelAllView.as_view(),
