...
class VulnerableGroup(BaseModel):
    ...
    administrative_level = models.ForeignKey(
        AdministrativeLevel, null=False, on_delete=models.CASCADE
    )
...
class VillagePriority(BaseModel):
    ...
    parent = models.ForeignKey(
        "VillagePriority", null=True, blank=True, on_delete=models.CASCADE
    )
    meeting = models.ForeignKey("VillageMeeting", on_delete=models.CASCADE)
    ranking = models.IntegerField(default=0)
...
class Component(BaseModel):
    name = models.CharField(max_length=255)
    parent = models.ForeignKey(
        "Component", null=True, blank=True, on_delete=models.CASCADE
    )
