...
urlpatterns = [
    ...
    path(
        "create-infra-or-link-subproject/<int:subproject_id>/",
        views.SubSubprojectCreateView.as_view(),
        name="create_infra_or_link_subproject",
    ),
    path("update/<int:pk>/", views.SubprojectUpdateView.as_view(), name="update"),
    path(
        "vulnerable-group/create",
        views.VulnerableGroupCreateView.as_view(),
        name="vulnerable_group_create",
    ),
    path(
        "image/<int:file_id>/delete",
        views.subprojectfile_delete,
        name="subproject_file_delete",
    ),
    path(
