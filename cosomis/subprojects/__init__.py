...
TYPES_OF_SUB_PROJECT = (
    ...
    (
        "Forage Photovoltaïque (Centre communautaire)",
        _("Photovoltaic drilling (Community center)"),
    ),
    ...
    (
        "Forage Photovoltaïque (Maraichage)",
        _("Photovoltaic drilling (market gardening)"),
    ),
    ("USP", _("USP")),
    ...
    (
        "Forage Photovoltaïque (Maison des jeunes)",
        _("Photovoltaic drilling (youth center)"),
    ),
    ("Salle de réunion", _("Meeting room")),
    (
        "Forage Photovoltaïque (Salle de réunion)",
        _("Photovoltaic drilling (Meeting room)"),
    ),
